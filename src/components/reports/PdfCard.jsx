...
const PdfCard = ({ title, reportPeriod, stats, monthlyProductData }) => {
    ...
    const handleShare = async (blob) => {
        ...
        window.location.href = `mailto:?subject=${encodeURIComponent(`Order report`)}&body=${encodeURIComponent(`Kindly find attached report on orders we recieved`)}`;
    }
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.thin}>
                Report on orders made in this {reportPeriod}
            </div>
